**This tool is designed to work with DEFRA emission factors for transport and compare with Google TIM emission factors**.
**For the Google TIM you must have a valid API key that needs to be entered into the Jupyter notebook otherwise it defaults to DEFRA**
